        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    required
                    type="text"
                    placeholder="Ex: Vacina V10, Seringa 3ml, Apoquel 16mg..."
              ...
              {/* Unidade de Medida (ML e Comprimido incluídos conforme pedido) */}
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 ml-1">Unidade de Medida</label>
                <div className="relative group">
                  <Scale size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-500 transition-colors" />
                  <select className="w-full pl-12 pr-4 py-4 rounded-2xl border border-slate-200 bg-slate-50 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all font-semibold appearance-none">
              ...
              {/* Estoque Mínimo */}
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 ml-1">Estoque Mínimo</label>
                <div className="relative group">
                  <AlertCircle size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-rose-500 transition-colors" />
                  <input 
                    type="number"
                    placeholder="5"
                    className="w-full pl-12 pr-4 py-4 rounded-2xl border border-slate-200 bg-slate-50 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all font-semibold"
              ...
              {/* Preço de Custo (Opcional, mas útil para o financeiro) */}
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 ml-1">Custo Unitário (R$)</label>
                <div className="relative group">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs group-focus-within:text-emerald-500 transition-colors">R$</div>
                  <input 
                    type="number"
                    step="0.01"
                    placeholder="0,00"
